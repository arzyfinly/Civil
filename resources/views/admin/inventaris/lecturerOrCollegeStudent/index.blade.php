    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">{{ __('Inventaris Dosen / Mahasiswa') }}</h3>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="border-radius: 15px">
                    <div class="modal-body">
                        @include('admin.inventaris.lecturerOrCollegeStudent.create')
                    </div>
                </div>
            </div>
        </div>
...
@include('admin.inventaris.lecturerOrCollegeStudent.scriptDelete')
@endsection
