    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">{{ __('BA Pelaksanaan') }}</h3>
            ...
            <table class="table table-flush" id="myTable">
                <div class="table-responsive py-4">
                    ...
                    <tbody>
                        @foreach ($bapelaksanaan as $row)
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>{{ $row->practicumRegistration->collageStudent->first_name . " " . $row->practicumRegistration->collageStudent->first_name  }}</td>
                                <td>{{ $row->status }}</td>
                                @role('admin')
