...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::get('/praktikum/get/grade',              [App\Http\Controllers\PraktikumController::class,  'getGrade']);
    ...
    Route::resource('baPelaksanaan',                BaPelaksanaanController::class);
